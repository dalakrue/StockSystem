...
def render_lunch_six_core_fields(*, state: MutableMapping[str, Any] | None = None) -> None:
    ...
    if selected_field == QUICK_DECISION_FIELD:
        ...
        st.caption("Fields 4 and 6 are displayed together for synchronization and phone flexibility. Calculations, caches and source logic remain independent.")
        nested = st.selectbox(
            "Combined 4+5+6 view",
...
def render_field456_independent(*, state: MutableMapping[str, Any] | None = None) -> None:
    ...
    st.caption("Fields 4 and 6 share one display surface. Calculations, caches and source logic remain independent.")
    from ui.lunch_identity_strip_20260626 import render_lunch_identity_strip
