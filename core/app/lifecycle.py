...
def _safe_run_page(tab_name, show_func, runtime_context=None):
    ...
    try:
        ...
        if not compact_merged_lunch:
            ...
            # The legacy page-status/system-relationship expander was removed
            # from the single-page Field 3 shell.  Keep the lightweight
            # timing/quality hooks above without adding another visible panel.
        else:
