...
MAIN_COLUMNS = [
    "Rank", "Symbol", "Lower Regime", "Lower Bias",
    "Middle Regime", "Middle Bias",
    "Higher Regime", "Higher Bias",
    "Three-Regime Agreement", "DCC Correlation Penalty",
    "HRP Cluster", "Spillover TO", "Spillover FROM", "Net Spillover", "Composite Bias",
    "Composite Score", "Decision Strength", "Entry Permission",
